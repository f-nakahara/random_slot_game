...
import 'package:random_slot_game/presentation/target_setting/widget/target_create_form/target_create_form_controller.dart';

class TargetCreateForm extends HookConsumerWidget {
  const TargetCreateForm({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.read(targetCreateFormController.notifier);
    final textEditingController = useTextEditingController();
    final localization = AppLocalization.of(context)!;
    final isEnable = ref.watch(targetCreateFormController).isEnabled;
