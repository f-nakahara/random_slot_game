...
import 'package:random_slot_game/presentation/action_setting/widget/action_create_form/action_create_form_controller.dart';
import 'package:random_slot_game/presentation/common/text_form_dialog.dart';

class ActionCreateForm extends HookConsumerWidget {
  const ActionCreateForm({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.read(actionCreateFormController.notifier);
    final textEditingController = useTextEditingController();
    final localization = AppLocalization.of(context)!;
    final isEnable = ref.watch(actionCreateFormController).isEnabled;
    return GestureDetector(
      ...
      child: TextFormDialog(
        onSaved: isEnable
            ...
            : null,
        title: localization.createTitle(localization.action),
